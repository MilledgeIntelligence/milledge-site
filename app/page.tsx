        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-10 items-start">
            <div>
              ...
              <p className="mt-3 text-slate-300 max-w-xl">Executives, owners, and procurement leaders at OEMs and renewable-energy firms use Milledge to time contracts, structure terms with mills and suppliers, and communicate clearly with boards and customers.</p>
