...
export default function MilledgeLanding() {
  ...
  const openCalendlyPrefilled = (name = "", email = "", company = "", notes = "") => {
    if (typeof window === "undefined") return;
    const w = window;
  ...
  const handleContactSubmit = (e) => {
    ...
    const notes = (form.querySelector('textarea[name="message"]')?.value || "").trim();
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              ...
              <p className="mt-5 text-slate-600 text-base sm:text-lg max-w-xl">
                We help steel buyers pre-position volume, sequence purchases to capacity and lead times,
                and stabilize delivered costs through a clear coverage framework.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-start">
            <div>
              ...
              <p className="mt-3 text-slate-300 max-w-xl">
                Executives, owners, and procurement leaders use Milledge to time contracts, structure terms, and communicate
                clearly with boards and customers.
              </p>
